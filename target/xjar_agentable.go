...
var xJar = XJar{
	md5:  []byte{44, 116, 244, 167, 243, 240, 226, 7, 197, 142, 32, 10, 190, 210, 53, 91},
	sha1: []byte{114, 138, 70, 72, 128, 185, 203, 97, 130, 16, 159, 53, 146, 198, 188, 18, 19, 189, 242, 193},
}
...
var xKey = XKey{
	...
	password:  []byte{89, 111, 117, 114, 83, 116, 114, 111, 110, 103, 80, 97, 115, 115, 119, 111, 114, 100, 49, 50, 51, 33, 64, 35},
}
